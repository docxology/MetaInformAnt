# Personal AI Infrastructure (PAI) - eqtl

## 🧠 Context & Intent
- **Path**: `/Volumes/external_drive/Git/projects/ongoing/Bioinformatics/MetaInformAnt/scripts/eqtl`
- **Purpose**: Functionality for eqtl.
- **Domain**: scripts
