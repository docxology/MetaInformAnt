...
def plot_kinship_heatmap(
    ...
    try:
        ...
        # Create heatmap
        im = ax.imshow(kinship_matrix, cmap="RdYlBu_r", aspect="auto", vmin=min_relatedness, vmax=max_relatedness)
        ...
        stats_text = (
            f"Mean: {mean_relatedness:.4f}, SD: {std_relatedness:.4f}\n"
    ...
    try:
        ...
        if phenotypes and color_by and color_by in phenotypes:
            ...
            if len(unique_vals) <= 10:  # Categorical
                scatter = ax.scatter(
                    pc_x_vals, pc_y_vals, c=pheno_vals, cmap="tab10", s=50, alpha=0.7, edgecolors="black", linewidth=0.5
                )
            ...
            # Default: no coloring
            ax.scatter(pc_x_vals, pc_y_vals, c="steelblue", s=50, alpha=0.7, edgecolors="black", linewidth=0.5)
