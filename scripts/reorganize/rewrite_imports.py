...
from . import (
    bayesian, core, decision_theory, epidemiology, evolutionary_dynamics, population_genetics, quantitative_genetics
)

__all__ = [
    "bayesian", "core", "decision_theory", "epidemiology",
    "evolutionary_dynamics", "population_genetics", "quantitative_genetics",
]
''',
    "information": '''\
...
__all__ = [
    "alignment", "annotation", "expression", "external", "integration",
    "io", "phylogeny", "population", "sequence", "variation",
]
''',
    "epigenome": '''\
...
__all__ = [
    "analysis", "behavior", "chemical", "data", "electronic", "gwas_integration", "morphological", "sonic", "workflow",
]
''',
    "multiomics": '''\
...
CANONICAL_MAP: dict[str, dict[str, str]] = {
    ...
    "simulation": {
        ...
        "animate_population_dynamics": "metainformant.visualization.analysis.simulation_plots",
        "animate_sequence_evolution": "metainformant.visualization.analysis.simulation_plots",
        ...
        "create_interactive_simulation_dashboard": "metainformant.visualization.analysis.simulation_plots",
        ...
        "plot_agent_based_model_results": "metainformant.visualization.analysis.simulation_plots",
        "plot_evolutionary_simulation_summary": "metainformant.visualization.analysis.simulation_plots",
        "plot_population_dynamics_simulation": "metainformant.visualization.analysis.simulation_plots",
        "plot_rnaseq_simulation_results": "metainformant.visualization.analysis.simulation_plots",
        "plot_sequence_evolution": "metainformant.visualization.analysis.simulation_plots",
        "plot_simulation_parameter_sensitivity": "metainformant.visualization.analysis.simulation_plots",
        "plot_simulation_validation_comparison": "metainformant.visualization.analysis.simulation_plots",
