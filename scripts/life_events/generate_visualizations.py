...
def main():
    ...
    try:
        ...
        plot_event_cooccurrence(sequences, output_path=output_dir / "event_cooccurrence.png", top_n=20)
    ...
    if outcomes is not None:
        try:
            ...
            plot_outcome_distribution(
                outcomes, output_path=output_dir / "outcome_distribution.png", plot_type="histogram"
            )
    ...
    try:
        ...
        plot_sequence_similarity(sequences, embeddings=embeddings, output_path=output_dir / "sequence_similarity.png")
    ...
    try:
        ...
        plot_transition_network(sequences, output_path=output_dir / "transition_network.png", top_n=15)
    ...
    try:
        ...
        plot_domain_timeline(sequences, output_path=output_dir / "domain_timeline.png", max_sequences=10)
    ...
    if outcomes is not None:
        try:
            ...
            plot_temporal_patterns(
                sequences, importance_scores=importance_scores, output_path=output_dir / "temporal_patterns.png"
            )
    ...
    try:
        ...
        plot_event_frequency_heatmap(sequences, output_path=output_dir / "event_frequency_heatmap.png", time_bins=10)
    ...
    if embeddings is not None:
        try:
            ...
            plot_embedding_clusters(
                embeddings, clusters=None, method="umap", output_path=output_dir / "embedding_clusters.png"
            )
