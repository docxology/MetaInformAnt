...
EXCLUDE_DIRS = {
    ...
    ".venv",
    ".tmp",
    "metainformant.egg-info",
    "html",
    "doctrees",  # Sphinx build artifacts
}
...
def get_dir_context(path: Path) -> dict:
    ...
    """
    context = {"description": f"Functionality for {path.name}.", "modules": [], "classes": [], "functions": []}
