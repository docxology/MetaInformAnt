...
def main():
    ...
    config = {
        "workflow": "demo",
        "version": "1.0.0",
        "parameters": {"threshold": 0.05, "iterations": 100, "method": "example"},
    ...
    try:
        ...
        viz_metadata = {
            "visualizations_generated": [str(fig1_path.name), str(fig2_path.name), str(fig3_path.name)],
            "format": "PNG",
            "dpi": 300,
    ...
    summary = {
        ...
        "files_generated": {
            ...
            "visualizations": [str(fig1_path), str(fig2_path), str(fig3_path)],
        },
