  ...
  %(prog)s --type features --n-samples 150 --n-features 100
    ...
    try:
        if args.type == "classification":
            results = simulate_classification(
                output_dir, args.n_samples, args.n_features, args.n_classes, args.seed
            )
        elif args.type == "regression":
            results = simulate_regression(
                output_dir, args.n_samples, args.n_features, args.noise, args.seed
            )
        elif args.type == "features":
            results = simulate_features(
                output_dir, args.n_samples, args.n_features, args.feature_types, args.seed
            )
