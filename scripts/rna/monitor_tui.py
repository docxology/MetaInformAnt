...
# Constants
SPECIES_COUNTS = {
    "anoplolepis_gracilipes": 2,
    "acromyrmex_echinatior": 8,
    "dinoponera_quadriceps": 13,
    "vollenhovia_emeryi": 15,
    "odontomachus_brunneus": 19,
    "formica_exsecta": 23,
    "temnothorax_americanus": 32,
    "wasmannia_auropunctata": 33,
    "nylanderia_fulva": 40,
    "temnothorax_curvispinosus": 43,
    "pogonomyrmex_barbatus": 95,
    "cardiocondyla_obscurior": 162,
    "temnothorax_nylanderi": 166,
    "linepithema_humile": 173,
    "atta_cephalotes": 220,
    "ooceraea_biroi": 237,
    "camponotus_floridanus": 304,
    "solenopsis_invicta": 349,
    "monomorium_pharaonis": 370,
    "temnothorax_longispinosus": 508,
    "harpegnathos_saltator": 689,
    "apis_mellifera": 3154,
}
...
def get_species_status(args):
    ...
    Path("output/amalgkit") / species_name
    ...
    fastq_dirs = [sp_dir / "fastq" / "getfastq", sp_dir / "work" / "getfastq"]
...
def generate_dashboard(sys_monitor, species_data) -> Group:
    ...
    for proc in metrics["procs"]:
        proc_table.add_row(str(proc["pid"]), proc["cmd"][:50], f"{proc['cpu']:.1f}")
    ...
    with Live(refresh_per_second=1, console=console) as live:
        try:
            while True:
                ...
                monitor.get_metrics()  # This updates self.all_relevant_procs
