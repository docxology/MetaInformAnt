...
def parse_args():
    ...
    parser.add_argument("--config-dir", default="config/amalgkit", help="Directory containing amalgkit YAML configurations.")
    parser.add_argument("--cache-dir", default=".cache/orthodb", help="Directory to cache OrthoDB gzip downloads.")
    parser.add_argument("--out-dir", default="output/amalgkit/cross_species/orthologs", help="Directory to deposit the outcome.")
