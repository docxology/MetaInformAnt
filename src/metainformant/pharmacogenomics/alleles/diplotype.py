...
_ACTIVITY_SCORE_TABLES: dict[str, dict[str, float]] = {
    "CYP2D6": {
        ...
        "*11": 0.0, "*12": 0.0, "*14": 0.0, "*15": 0.0, "*36": 0.0,
    },
    "CYP2C19": {
        "*1": 1.0, "*17": 1.5,
...
def calculate_activity_score(
    ...
    """
    score = calculate_activity_score_from_alleles(
        diplotype.allele1, diplotype.allele2, gene.upper(), scoring_table
    )
