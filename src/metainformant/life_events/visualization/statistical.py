"""Statistical visualization functions for life events analysis.

This module provides statistical plotting utilities for life event sequences,
including embeddings, attention heatmaps, prediction accuracy, and comparison plots.
"""
...
def plot_intervention_effects(
    pre_sequences: List[Any],
    post_sequences: List[Any],
    pre_outcomes: Optional[Any] = None,
    post_outcomes: Optional[Any] = None,
...
def plot_population_comparison(
    group1_sequences: List[Any],
    group2_sequences: List[Any],
...
def plot_prediction_accuracy(
    ...
    if task_type == "classification":
        ...
        ax.set_title(f"Prediction {task_type.title()}")
...
def plot_sequence_length_distribution(
    sequences: List[Any], output_path: Optional[Union[str, Any]] = None, figsize: Tuple[int, int] = (10, 6)
) -> Any:
...
def plot_sequence_similarity(
    sequences: List[Any], output_path: Optional[Union[str, Any]] = None, figsize: Tuple[int, int] = (10, 8)
) -> Any:
