...
## 🧠 Context & Intent
- **Path**: `/Volumes/external_drive/Git/projects/ongoing/Bioinformatics/MetaInformAnt/src/metainformant/networks/workflow`
- **Purpose**: Network analysis workflow orchestration.
- **Domain**: networks
