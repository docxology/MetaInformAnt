...
def plot_forecast(
    ...
    **kwargs,
    ...
    # Plot forecast
    ax.plot(forecast.index, forecast.values, label="Forecast", color="red", linestyle="--", **kwargs)
...
def plot_trend_analysis(
    ...
    # Plot trend line
    ax.plot(data.index, trend_line, label=f"Trend (slope: {coefficients[0]:.4f})", color="red", linewidth=2)
