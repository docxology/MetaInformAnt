# GWAS Module Technical Specification

## Architecture
The `gwas` module is a component of the `metainformant` package, designed to encapsulate genome-wide association studies workflow.
