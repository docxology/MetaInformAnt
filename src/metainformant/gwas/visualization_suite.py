...
def generate_all_plots(association_results: Path, output_dir: Path,
    ...
    try:
        ...
        try:
            ...
            plot = manhattan_plot(df, output_file=manhattan_file,
        ...
        try:
            ...
            for i, (_, hit) in enumerate(top_hits.iterrows()):
                ...
                plot = regional_plot(df, chrom, pos-500000, pos+500000,
                                   output_file=regional_file)
                if plot:
