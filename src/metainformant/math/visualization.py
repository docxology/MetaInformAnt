...
def plot_population_genetics_summary(
    ...
    **kwargs
    ...
    bars = ax.bar(x_positions, stat_values, yerr=stat_errors,
...
def plot_evolutionary_trajectory(
    ...
    **kwargs
    ...
    # Plot trajectory
    ax.plot(x_data, trajectory_data, 'b-', linewidth=2, marker='o',
    ...
    if kwargs.get('show_trend', False):
        ...
        ax.plot(x_data, trend_line, 'r--', linewidth=1, alpha=0.7,
...
def plot_moran_model_evolution(
    ...
    **kwargs
    ...
    ax.plot(time_points, mutant_frequencies, 'b-', linewidth=2, marker='o',
...
def plot_price_equation_components(
    ...
    **kwargs
    ...
    for i, (component_name, values) in enumerate(price_components.items()):
        ax.plot(time_points, values, color=colors[i], linewidth=2,
               label=component_name, alpha=0.8)
    ...
    **kwargs
    ...
    for compartment, values in epidemic_data.items():
        ...
        ax.plot(time_points, values, color=color, linewidth=2,
               label=compartment.capitalize(), alpha=0.8)
    ...
    if population_labels is not None:
        ...
        for i, pop in enumerate(unique_pops):
            ...
            ax.scatter(pca_coords[mask, 0], pca_coords[mask, 1],
                      c=[colors[i]], label=str(pop), alpha=0.7, s=50)
    else:
...
def create_interactive_population_genetics_dashboard(
    ...
    **kwargs
    ...
    fig.update_layout(
        title="Interactive Population Genetics Dashboard",
        **kwargs
    )
