"""Gene annotation, classification, and regulatory element analysis.

This module provides tools for annotating coding regions, finding regulatory
elements, masking repeats, annotating CpG islands, computing codon usage
statistics, and identifying splice sites in DNA sequences.
"""
