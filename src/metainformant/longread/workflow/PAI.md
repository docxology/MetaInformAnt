...
## 🧠 Context & Intent
- **Path**: `/Volumes/external_drive/Git/projects/ongoing/Bioinformatics/MetaInformAnt/src/metainformant/longread/workflow`
- **Purpose**: Long-read workflow orchestration module.
- **Domain**: longread
