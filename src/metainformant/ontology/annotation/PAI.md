...
## 🧠 Context & Intent
- **Path**: `/Volumes/external_drive/Git/projects/ongoing/Bioinformatics/MetaInformAnt/src/metainformant/ontology/annotation`
- **Purpose**: Annotation bridge: GWAS hits -> genes -> GO annotations.
- **Domain**: ontology
