...
## 🧠 Context & Intent
- **Path**: `/Volumes/external_drive/Git/projects/ongoing/Bioinformatics/MetaInformAnt/src/metainformant/ontology/workflow`
- **Purpose**: Ontology workflow entry points.
- **Domain**: ontology
