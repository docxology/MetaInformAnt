...
def get_sample_pipeline_status(sample_id: str, work_dir: Path, 
                               fastq_dir: Optional[Path] = None,
                               quant_dir: Optional[Path] = None) -> Dict[str, Any]:
...
def validate_sample_end_to_end(sample_id: str, work_dir: Path,
                                fastq_dir: Optional[Path] = None,
                                quant_dir: Optional[Path] = None) -> Dict[str, Any]:
...
def validate_all_samples(config: AmalgkitWorkflowConfig,
    ...
    try:
        ...
        with open(metadata_file, 'r') as f:
            ...
            for row in reader:
                ...
                sample_id = (row.get(sample_id_key, '') or 
                            row.get('run', '') or 
                            row.get('Run', '') or 
                            row.get('SRA_Run', '') or
