...
def check_workflow_progress(config_path: Path) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"quantified": 0, "total": 0, "percentage": 0.0, "remaining": 0, "downloading": 0, "has_files": False}
...
def initialize_progress_tracking(config_path: Path) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"success": True, "total_samples": len(sample_ids), "sample_ids": sample_ids}
    except Exception as e:
