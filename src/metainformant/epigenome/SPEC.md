# Epigenome Module Technical Specification

## Architecture
The `epigenome` module is a component of the `metainformant` package, designed to encapsulate epigenetic modification analysis.
