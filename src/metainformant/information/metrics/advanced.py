...
def relative_information_gain(
    ...
    """
    from .syntactic import kl_divergence
...
def variation_of_information(
    ...
    """
    from .syntactic import joint_entropy, mutual_information
...
def interaction_information(
    ...
    Raises:
        ValueError: If sequences have different lengths
    """
    from .syntactic import conditional_mutual_information, mutual_information
...
def binding_information(
    ...
    Raises:
        ValueError: If sequences have different lengths
    """
    from .syntactic import mutual_information
