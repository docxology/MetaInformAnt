...
try:
    from metainformant.information.metrics.syntactic import kl_divergence, shannon_entropy
...
# ---------------------------------------------------------------------------
# Internal helpers for channel / rate-distortion / bottleneck functions
# ---------------------------------------------------------------------------
