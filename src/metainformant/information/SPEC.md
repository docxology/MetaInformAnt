# Information Module Technical Specification

## Architecture
The `information` module is a component of the `metainformant` package, designed to encapsulate information-theoretic analysis for biological data.
