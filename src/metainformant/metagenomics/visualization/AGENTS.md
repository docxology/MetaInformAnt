# AGENTS.md — `src/metainformant/metagenomics/visualization`

Sub-package `visualization` of the `metagenomics` domain module
(verified 2026-08-29: 3 files, 0 subdirs).
