...
class TestGenotypeSV:
    def test_heterozygous_genotype(self):
        ...
        reads = [{"name": f"ref_{i}", "chrom": "chr1", "pos": 800, "read_length": 300, "mapq": 60} for i in range(10)]
...
class TestCallStructuralVariants:
    ...
    def test_no_evidence_low_quality(self):
        reads = [{"name": "r1", "chrom": "chr1", "pos": 100, "cigar": "100M", "mapq": 5}]
