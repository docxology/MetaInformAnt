...
def test_generate_realistic_with_noise(tmp_path):
    ...
    sequences, outcomes = generate_synthetic_life_events(n_sequences=10, generate_outcomes=True, random_state=42)
...
def test_generate_realistic_cooccurrence(tmp_path):
    ...
    sequences, _ = generate_synthetic_life_events(n_sequences=20, random_state=42)
