...
| [`tests/gwas/`](../tests/gwas/) | GWAS pipeline | 59 | 717 |
...
| [`tests/mcp/`](../tests/mcp/) | MCP server and tools | 8 | 69 |
...
| [`tests/networks/`](../tests/networks/) | Network analysis | 7 | 323 |
...
| [`tests/rna/`](../tests/rna/) | RNA-seq workflows | 54 | 971 |
| [`tests/simulation/`](../tests/simulation/) | Simulation | 5 | 428 |
