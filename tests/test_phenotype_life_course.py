...
class TestExtractPhenotypesFromEvents:
    ...
    def test_custom_phenotype_categories(self):
        ...
        custom_categories = {"medical_events": ["diagnosis", "treatment", "hospitalization"]}
    ...
    def test_invalid_custom_categories(self):
        ...
        invalid_categories = {"test": "not a list"}
...
class TestAggregateTemporalPhenotypes:
    ...
    def test_basic_aggregation(self):
        ...
        seq1 = EventSequence(person_id="p1", events=[Event("event1", datetime(2010, 1, 1), "health")])
        seq2 = EventSequence(person_id="p2", events=[Event("event2", datetime(2015, 1, 1), "education")])
...
class TestMapEventsToTraits:
    ...
    def test_custom_mapping(self):
        ...
        custom_mapping = {"custom_trait": ["custom_event", "other_event"]}
    ...
    def test_invalid_trait_mapping(self):
        ...
        invalid_mapping = {"trait": "not a list"}
