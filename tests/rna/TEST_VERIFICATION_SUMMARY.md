...
|------|---------|------------|--------|
| `test_rna_amalgkit.py` | Basic CLI functionality | 4 functions | [DONE] Complete |
| `test_rna_amalgkit_cli_args.py` | CLI argument building (v0.12.20 enhanced) | 5 functions | [DONE] Complete |
| `test_rna_amalgkit_comprehensive.py` | Comprehensive integration | 25 functions, 8 classes | [DONE] Complete |
| `test_rna_amalgkit_end_to_end.py` | End-to-end workflows | 13 functions, 4 classes | [DONE] Complete |
| `test_rna_amalgkit_steps.py` | Individual step runners | 75 functions, 17 classes | [DONE] Complete |

### Specialized Test Files

| File | Purpose | Status |
|------|---------|--------|
| `test_rna_workflow.py` | Workflow planning and ordering | [DONE] Complete |
| `test_rna_workflow_error_handling.py` | Error handling and recovery | [DONE] Complete |
| `test_rna_workflow_manifest.py` | Manifest generation | [DONE] Complete |
| `test_rna_config_load_plan.py` | Configuration loading | [DONE] Complete |
| `test_rna_configs.py` | Species configuration | [DONE] Complete |
| `test_rna_download_skip.py` | Download skip logic | [DONE] Complete |
| `test_rna_download_validation.py` | Download validation | [DONE] Complete |
| `test_rna_ena_workflow.py` | ENA workflow integration | [DONE] Complete |
| `test_rna_manifest.py` | Manifest functionality | [DONE] Complete |
| `test_rna_orchestrators.py` | Orchestrator scripts | [DONE] Complete |
| `test_rna_pipeline.py` | Pipeline functionality | [DONE] Complete |
| `test_rna_preflight_manifest.py` | Preflight manifests | [DONE] Complete |
| `test_rna_run_amalgkit_logging.py` | Logging functionality | [DONE] Complete |
| `test_rna_run_config_cli.py` | CLI execution | [DONE] Complete |
| `test_rna_step_runners_dispatch.py` | Step dispatch | [DONE] Complete |
| `test_rna_steps_comprehensive.py` | Step module imports | [DONE] Complete |
| `test_rna_workflow_config.py` | Workflow configuration | [DONE] Complete |
| `test_rna_workflow_deps.py` | Dependency checking | [DONE] Complete |
| `test_rna_cli.py` | CLI commands | [DONE] Complete |
