...
def main():
    ...
    expression_results = {
        "rna_expression_quantification_demo": {
            ...
            "input_data": {"genes": genes, "samples": list(raw_counts.keys()), "gene_lengths": gene_lengths},
            ...
            "summary_statistics": {
                ...
                "genes_with_expression": sum(
                    1 for gene_idx in range(len(genes)) if any(counts[gene_idx] > 0 for counts in raw_counts.values())
                ),
