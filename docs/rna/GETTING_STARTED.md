...
See **[TROUBLESHOOTING_RNA.md](TROUBLESHOOTING_RNA.md)** for common issues:
- "amalgkit: command not found", "fasterq-dump: command not found"
- Permission denied errors
- External drive / filesystem issues
- PEP 668 errors
- Downloads failing, disk space issues
