# AMALGKIT Integration: Guide

This document provides a guide to METAINFORMANT's amalgkit integration, covering all aspects from basic usage to advanced configuration and troubleshooting.
