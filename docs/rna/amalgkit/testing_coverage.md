...
|----------|-------|----------|
| `build_cli_args` | 7 tests | [DONE] Complete |
| `build_amalgkit_command` | 3 tests | [DONE] Complete |
| `check_cli_available` | 2 tests | [DONE] Complete |
| `ensure_cli_available` | 2 tests | [DONE] Complete |
| `run_amalgkit` | 11 tests (via step runners) | [DONE] Complete |

#### Step Wrapper Functions Tested

| Function | Tests | Coverage |
|----------|-------|----------|
| `metadata()` | 3 tests | [DONE] Complete |
| `integrate()` | 3 tests | [DONE] Complete |
| `config()` | 3 tests | [DONE] Complete |
| `select()` | 3 tests | [DONE] Complete |
| `getfastq()` | 3 tests | [DONE] Complete |
| `quant()` | 3 tests | [DONE] Complete |
| `merge()` | 3 tests | [DONE] Complete |
| `cstmm()` | 3 tests | [DONE] Complete |
| `curate()` | 3 tests | [DONE] Complete |
| `csca()` | 3 tests | [DONE] Complete |
| `sanity()` | 3 tests | [DONE] Complete |
...
|--------|----------|-------|----------|
| `metadata.py` | `run()` | 3 tests | [DONE] Complete |
| `integrate.py` | `run()` | 3 tests | [DONE] Complete |
| `config.py` | `run()` | 3 tests | [DONE] Complete |
| `select.py` | `run()` | 3 tests | [DONE] Complete |
| `getfastq.py` | `run()` | 3 tests + special tests | [DONE] Complete |
| `quant.py` | `run()` | 3 tests | [DONE] Complete |
| `merge.py` | `run()` | 3 tests | [DONE] Complete |
| `cstmm.py` | `run()` | 3 tests | [DONE] Complete |
| `curate.py` | `run()` | 3 tests | [DONE] Complete |
| `csca.py` | `run()` | 3 tests | [DONE] Complete |
| `sanity.py` | `run()` | 3 tests | [DONE] Complete |
...
|-----------|---------|------------|--------|
| `test_rna_amalgkit.py` | Basic amalgkit functionality | 4 tests | [DONE] Passing |
| `test_rna_amalgkit_cli_args.py` | CLI argument building | 1 test | [DONE] Passing |
| `test_rna_run_amalgkit_logging.py` | Logging functionality | 1 test | [DONE] Passing |
| `test_rna_amalgkit_comprehensive.py` | Integration tests | 24 tests | [DONE] All passing |
| `test_rna_amalgkit_steps.py` | **Complete step coverage** | 71 tests | [DONE] All passing |
| `test_rna_amalgkit_end_to_end.py` | End-to-end workflows | 11 tests | [DONE] All passing/skipped |
| `test_rna_workflow.py` | Workflow orchestration | 1 test | [DONE] Passing |
| `test_rna_workflow_config.py` | Configuration loading | 1 test | [DONE] Passing |
| `test_rna_workflow_deps.py` | Dependency checking | 1 test | [DONE] Passing/skipped |
| `test_rna_workflow_manifest.py` | Manifest generation | 1 test | [DONE] Passing/skipped |
| `test_rna_config_load_plan.py` | Config loading and planning | 2 tests | [DONE] Passing |
| `test_rna_configs.py` | Species configuration | 2 tests | [DONE] Passing |
| `test_rna_manifest.py` | Manifest generation | 1 test | [DONE] Passing |
| `test_rna_step_runners_dispatch.py` | Step runner dispatch | 1 test | [DONE] Passing/skipped |
| `test_rna_preflight_manifest.py` | Preflight manifests | 1 test | [DONE] Passing/skipped |
| `test_rna_run_config_cli.py` | CLI execution | 2 tests | [DONE] Passing/skipped |
| `test_rna_cli.py` | CLI commands | 2 tests | [DONE] Passing |
| `test_rna_orchestrators.py` | Orchestrator scripts | 9 tests | [DONE] Passing |
| `test_rna_ena_workflow.py` | ENA workflow | 20 tests | [DONE] Passing |
| `test_rna_pipeline.py` | Pipeline configuration | 6 tests | [DONE] Passing |
...
|---------|---------|--------|-------|
| Apis mellifera | 6,577 | [DONE] Complete | Metadata format fix applied |
| Camponotus floridanus | 307 | [DONE] Complete | Cloud acceleration enabled |
| Monomorium pharaonis | 145 | [DONE] Complete | Parallel downloads working |
| Pogonomyrmex barbatus | 120 | [DONE] Complete | Original working configuration maintained |
| Solenopsis invicta | 98 | [DONE] Complete | Disk space management validated |
 ...
 **Coverage reporting requires pytest-cov installation**
