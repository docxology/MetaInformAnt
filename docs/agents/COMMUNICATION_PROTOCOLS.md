...
- [PipelineItem Metadata](#1-pipelineitem-metadata)
- [Configuration Objects](#2-configuration-objects)
- [File System Bridge](#3-file-system-bridge)
- [Logging as Side-Channel](#debug-logging-pattern)
