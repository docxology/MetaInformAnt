...
- Use `uv run` to execute commands: `uv run pytest`, `uv run metainformant quality --help`
...
**Patterns**:
```python
from metainformant.quality.io import fastq
...
- Real implementations only - use real file operations
