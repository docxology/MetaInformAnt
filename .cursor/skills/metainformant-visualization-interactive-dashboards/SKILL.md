...
# METAINFORMANT — `src/metainformant/visualization/interactive_dashboards`

Before editing files in this subtree:

- Read [`AGENTS.md`](../../../src/metainformant/visualization/interactive_dashboards/AGENTS.md) for this folder (canonical technical context).
- Optional overview: [`README.md`](../../../src/metainformant/visualization/interactive_dashboards/README.md).
