...
# METAINFORMANT — `projects/template_bioinformatics_project/data/processed`

Before editing files in this subtree:

- Read [`AGENTS.md`](../../../projects/template_bioinformatics_project/data/processed/AGENTS.md) for this folder (canonical technical context).
- Optional overview: [`README.md`](../../../projects/template_bioinformatics_project/data/processed/README.md).
