...
# METAINFORMANT — `src/metainformant/structural_variants/visualization`

Before editing files in this subtree:

- Read [`AGENTS.md`](../../../src/metainformant/structural_variants/visualization/AGENTS.md) for this folder (canonical technical context).
- Optional overview: [`README.md`](../../../src/metainformant/structural_variants/visualization/README.md).
