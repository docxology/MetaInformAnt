...
description: METAINFORMANT rules for directory scripts/gwas/pipelines. Use when editing, adding tests, or reviewing code under this path. Read the linked AGENTS.md first; use uv only, write outputs to output/, real implementations.
---
