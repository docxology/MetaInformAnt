...
# METAINFORMANT — `projects/hymenoptera_amalgkit/doc/04_troubleshooting`

Before editing files in this subtree:

- Read [`AGENTS.md`](../../../projects/hymenoptera_amalgkit/doc/04_troubleshooting/AGENTS.md) for this folder (canonical technical context).
- Optional overview: [`README.md`](../../../projects/hymenoptera_amalgkit/doc/04_troubleshooting/README.md).
